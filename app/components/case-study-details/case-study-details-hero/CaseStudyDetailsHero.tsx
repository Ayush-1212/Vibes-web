    ...
    >
      <div className="container mx-auto max-w-screen-xl px-4 md:px-8">
        <div className="grid grid-cols-12 items-center ">
          ...
          >
            <h1 className="font-poppins font-normal text-[35px] leading-[116%] capitalize text-white">
              {title}
              {highlightTitle && (
                <>
                  <br />
                  <span className="hero-highlight1 relative z-10 w-fit font-poppins font-semibold text-[40px] leading-[116%] capitalize text-white">
                    {highlightTitle}
                  </span>
                </>
              )}
